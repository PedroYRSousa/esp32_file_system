...
esp_err_t fs_file_mount_and_write(const char* file, const char* src, const char* mode, bool is_line)
{
	char file_path[1024] = "";
	...
	if (fs_file_open_and_write(file_path, src, mode, is_line) != ESP_OK)
	{
